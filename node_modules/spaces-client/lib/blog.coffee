...
class Blog
  ...
  @showBlog = (site, sessionId, resourceId, refObjId, userId, onsuccess, onfail) ->
    addlHeaders = []
    Resource.getResource(site.full_url, userId, sessionId, 'blogs/' + resourceId, addlHeaders, ((res) ->
      onsuccess()
    ), (() ->
      onfail()
    ))
