...
class Blog
  ...
  @showBlog = (site, sessionId, resourceId, parentId, userId, onsuccess, onfail) ->
    ...
    Resource.getResource(site, userId, sessionId, 'blogs/' + resourceId, addlHeaders, onsuccess, onfail)
  ...
  @deleteBlog = (site, sessionId, resourceId, parentId, userId, onsuccess, onfail, ondestroy) ->
  ...
  @showBlogpost = (site, sessionId, resourceId, parentId, userId, onsuccess, onfail) ->
    ...
    Resource.getResource(site, userId, sessionId, 'blog_posts/' + resourceId, addlHeaders, onsuccess, onfail)
