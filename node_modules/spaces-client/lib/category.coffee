...
class Category
  ...
  @createCategory = (site, sessionId, parentId, userId, onsuccess, onfail, oncreate) ->
    data = {
      category: {
        title: Faker.Lorem.sentences(1),
        body: Faker.Lorem.sentences(4)
    ...
    Resource.createResource(site, userId, sessionId, 'category', data, onsuccess, onfail, oncreate)
