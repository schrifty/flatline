...
#        tags: Faker.Lorem.words(3).join(" "),
  ...
  @showFolder = (site, sessionId, resourceId, parentId, userId, onsuccess, onfail) ->
    ...
    Resource.getResource(site, userId, sessionId, 'document_libraries/' + resourceId, addlHeaders, ((res) ->
      onsuccess()
    ), (() ->
      onfail()
    ))
  ...
  @showDocument = (site, sessionId, resourceId, parentId, userId, onsuccess, onfail) ->
    ...
    Resource.getResource(site, userId, sessionId, 'documents/' + resourceId, addlHeaders, ((res) ->
      onsuccess()
    ), (() ->
      onfail()
    ))
  ...
  @getPersonalDocLibId = (site, userId, sessionId, onsuccess) ->
    ...
    Resource.getResource(site, userId, sessionId, 'current_user/document_library.json', headers, ((folder) ->
