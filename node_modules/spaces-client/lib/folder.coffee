...
class Folder
  ...
  @createFolder = (site, sessionId, parentId, userId, onsuccess, onfail, oncreate) ->
    data = {
      document_library: {
...
#        tags: Faker.Lorem.words(3).join(" "),
    ...
    Resource.createResource(site, userId, sessionId, 'document_library', data, onsuccess, onfail, oncreate)
...
#    xhr.send(JSON.stringify(data))
  ...
  @createDocument = (site, sessionId, folderId, userId, onsuccess, onfail, oncreate) ->
  ...
  @deleteDocument = (site, sessionId, refObjId, userId, onsuccess, onfail, ondestroy) ->
    Resource.deleteResource(site, userId, sessionId, refObjId, 'document', onsuccess, onfail, ondestroy)
  ...
  @getPersonalDocLibId = (site, userId, sessionId, onsuccess) ->
    ...
    Resource.getResource(host, userId, sessionId, null, 'document_library', '/current_user/document_library', headers, ((folder) ->
