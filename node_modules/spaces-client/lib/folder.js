...
(function() {
  ...
  Folder = (function() {
    ...
    Folder.showFolder = function(site, sessionId, resourceId, parentId, userId, onsuccess, onfail) {
      var addlHeaders;
      addlHeaders = {
        "Accept": "application/vnd.moxiesoft.spaces-v1+json",
        "Cookie": ["_social_navigator_session=" + sessionId, "path=/"]
      };
      return Resource.getResource(site, userId, sessionId, 'document_libraries/' + resourceId, addlHeaders, onsuccess, onfail);
    };

    Folder.createFolder = function(site, sessionId, resourceId, parentId, userId, onsuccess, onfail, oncreate) {
      var data;
      data = {
        document_library: {
      ...
      return Resource.createResource(site, userId, sessionId, 'document_libraries', data, onsuccess, onfail, oncreate);
    };

    Folder.updateFolder = function(site, sessionId, resourceId, parentId, userId, onsuccess, onfail) {
      var data;
      data = {
        document_library: {
          title: Faker.Lorem.sentences(1)
      ...
      return Resource.editResource(site, userId, sessionId, 'document_libraries/' + resourceId, data, onsuccess, onfail);
    };

    Folder.deleteFolder = function(site, sessionId, resourceId, parentId, userId, onsuccess, onfail, ondestroy) {
      return Resource.deleteResource(site, userId, sessionId, 'document_libraries/' + resourceId, onsuccess, onfail, ondestroy);
    };

    Folder.showDocument = function(site, sessionId, resourceId, parentId, userId, onsuccess, onfail) {
      var addlHeaders;
      addlHeaders = {
        "Accept": "application/vnd.moxiesoft.spaces-v1+json",
        "Cookie": ["_social_navigator_session=" + sessionId, "path=/"]
      };
      return Resource.getResource(site, userId, sessionId, 'documents/' + resourceId, addlHeaders, onsuccess, onfail);
    };

    Folder.createDocument = function(site, sessionId, resourceId, folderId, userId, onsuccess, onfail, oncreate) {
      var Spaces;
    ...
    Folder.updateDocument = function(site, sessionId, resourceId, parentId, userId, onsuccess, onfail) {
      var data;
      data = {
        document: {
          title: Faker.Lorem.sentences(1)
      ...
      return Resource.editResource(site, userId, sessionId, 'documents/' + resourceId, data, onsuccess, onfail);
    };

    Folder.deleteDocument = function(site, sessionId, resourceId, parentId, userId, onsuccess, onfail, ondestroy) {
      return Resource.deleteResource(site, userId, sessionId, 'documents/' + resourceId, onsuccess, onfail, ondestroy);
    };
    ...
    Folder.getPersonalDocLibId = function(site, userId, sessionId, onsuccess) {
      ...
      return Resource.getResource(site, userId, sessionId, 'current_user/document_library.json', headers, (function(msecs, folder) {
        var folderId;
        folderId = folder.match(/"id":"(.*?)"/)[1];
        return onsuccess(folderId);
      }), (function() {
        return Spaces.logger.info("[%s][%s] Folder.getPersonalDocLibId Error", site.site_id, userId);
      }));
    };
