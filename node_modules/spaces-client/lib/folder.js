...
(function() {
  var $, Faker, Folder, Resource, exports, fs;
  ...
  Folder = (function() {
    ...
    Folder.create = function(site, parentId, userId) {
      ...
      xhr.onload = function() {
        ...
        if (this.status === 200 || this.status === 201) {
          ...
          return Spaces.logger.error("[%s][%s] Folder.create failed: %s - %s", site.site_id, userId, JSON.stringify(xhr));
        }
      };
      xhr.onerror = function(e) {
        return Spaces.logger.error(e);
      };
      return xhr.send(JSON.stringify(data));
    };

    Folder.createDocument = function(site, folderId, userId) {
      var Spaces, fileName, fileSize;
      Spaces = require('./spaces-client.js');
      ...
      return fs.readdir("./assets/files/", (function(err, files) {
        ...
        return fs.stat("./assets/files/" + fileName, (function(err, stats) {
          ...
          fileSize = stats.size;
          return Folder.initS3PresignedPost(site, userId, (function(data) {
            ...
            return Folder.uploadToS3(site, userId, data, fileName, fileSize, (function() {
              ...
              return Folder.createDocumentMetadata(folderId, site, userId, data, fileName, fileSize, (function(response) {
                var documentId;
                Spaces.logger.debug("[%s][%s] Created document [%s]", site.site_id, userId, documentId);
                documentId = response.id;
                return Spaces.Session.addItem(site, userId, 'document', documentId);
              }), (function(message) {
                return Spaces.logger.error(message);
              }));
            }), (function(message) {
              return Spaces.logger.error(message);
            }));
    ...
    Folder.deleteDocument = function(site, parentId, userId) {
      return Resource.deleteResource(site, userId, 'document');
    };

    Folder.initS3PresignedPost = function(site, userId, onsuccess, onfail) {
    ...
    Folder.createDocumentMetadata = function(folderId, site, userId, data, fileName, fileSize, onsuccess, onfail) {
      var Spaces, XMLHttpRequest, xhr;
      Spaces = require('./spaces-client.js');
      data = $.param({
        document: {
