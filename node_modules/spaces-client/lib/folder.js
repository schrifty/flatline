...
(function() {
  ...
  Folder = (function() {
    ...
    Folder.showFolder = function(site, sessionId, resourceId, parentId, userId, onsuccess, onfail) {
      ...
      return Resource.getResource(site, userId, sessionId, 'document_libraries/' + resourceId, addlHeaders, (function(res) {
        return onsuccess();
      }), (function() {
        return onfail();
      }));
    ...
    Folder.showDocument = function(site, sessionId, resourceId, parentId, userId, onsuccess, onfail) {
      ...
      return Resource.getResource(site, userId, sessionId, 'documents/' + resourceId, addlHeaders, (function(res) {
        return onsuccess();
      }), (function() {
        return onfail();
      }));
    ...
    Folder.getPersonalDocLibId = function(site, userId, sessionId, onsuccess) {
      ...
      return Resource.getResource(site, userId, sessionId, 'current_user/document_library.json', headers, (function(folder) {
        var folderId;
