...
(function() {
  ...
  Site = (function() {
    ...
    Site.createSite = function(data, onsuccess, onfail) {
      ...
      $ = require("jquery");
      return $.ajax(Spaces.mothershipUrl + '/api/sites', {
        type: 'POST',
        dataType: 'json',
        ...
        beforeSend: function(request) {
          ...
          return request.setRequestHeader("API-KEY", Spaces.apiKey);
        },
        error: function(jqXHR, textStatus, errorThrown) {
          Spaces.logger.error("Error creating site: %s - %s - %j", textStatus, errorThrown, jqXHR);
