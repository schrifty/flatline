...
(function() {
  ...
  SpacesClient = (function() {
    ...
    SpacesClient.Resource = require("./resource");

    SpacesClient.Site = require("./site");

    SpacesClient.User = require("./user");

    SpacesClient.Wiki = require("./wiki");
    ...
    SpacesClient.process = function(site, userId, action, sessionId, resourceId, parentId, handlers) {
