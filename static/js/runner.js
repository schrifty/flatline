...
(function() {
  var Runner, SITE_CREATE_FREQUENCY_MS, logger;
  ...
  Runner = (function() {
    var Action, Faker, Spaces, maxServers, maxSites, newUserPeriod;
    ...
    Runner.createSites = function() {
      ...
      return Spaces.Site.createSite(data, (function(site) {
        ...
        return logger.debug("Unable to create successfully - abandoning site [%s]", site.site_id);
      }));
    };
